...
const std::string dbPassword = "D3007_d2005"; //��������� ��� �� ���� ������. ��������� �� ���� ����� ����� ��
...
void Visit::write_visitrow()
{
	if (visitID == 0)
	{
		if (connect_todb())
		{
			std::string query = "INSERT INTO visit (clientID, doctorID, visitDate, timedate, visitStatus, diagnosis, prescription) VALUES ("
	...
	else
	{
		if (connect_todb())
		{
			std::string query = "UPDATE visit SET "
				...
				"datetime = '" + std::to_string(visitTime.tm_hour) + ":" + std::to_string(visitTime.tm_min) /* + ":" + std::to_string(visitDate.tm_sec) */ +", "
